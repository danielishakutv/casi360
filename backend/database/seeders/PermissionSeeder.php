    ...
    public function run(): void
    {
        ...
        */
        $roleDefaults = [
            ...
            /*
            | country_director: executive overseer. Sees every department
            | (view + *.view_all everywhere) and is the final approver on
            | payment documents (invoices here; RFP & disbursements gain
            | dedicated approve keys in the approval-chain migration). NOT a
            | system administrator — no user management, no settings editing,
            | no create/edit/delete on operational documents. Org-wide
            | dashboard visibility is enforced in code via DepartmentScope.
            */
            'country_director' => [
                'auth.users.view' => false,
                'auth.users.create' => false,
                ...
                'procurement.approval.finance_check' => false,
                'procurement.approval.operations_approval' => false,
                'procurement.approval.executive_approval' => true,
                'procurement.approval.self_approve' => false,
                'procurement.approvals.view' => true,
                'procurement.approvals.budget_holder' => false,
                'procurement.approvals.finance' => false,
