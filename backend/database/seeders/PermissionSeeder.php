    ...
    public function run(): void
    {
        ...
        */
        $permissions = [
            ...
            ['module' => 'procurement', 'feature' => 'purchase_orders', 'action' => 'view_all', 'description' => 'See every purchase order in the organisation, not just records that concern this user'],
            ...
            ['module' => 'procurement', 'feature' => 'requisitions', 'action' => 'view_all', 'description' => 'See every purchase request in the organisation, not just records that concern this user'],
            ...
            ['module' => 'procurement', 'feature' => 'boq', 'action' => 'view_all', 'description' => 'See every bill of quantities in the organisation, not just records that concern this user'],
            ...
            ['module' => 'procurement', 'feature' => 'rfq', 'action' => 'view_all', 'description' => 'See every request for quotation in the organisation, not just records that concern this user'],
            ...
            ['module' => 'procurement', 'feature' => 'rfp', 'action' => 'view_all', 'description' => 'See every request for payment in the organisation, not just records that concern this user'],

            // --- Procurement: Invoices (vendor invoices, gate the RFP) ---
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'view',     'description' => 'View vendor invoices list and details'],
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'create',   'description' => 'Record new vendor invoices'],
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'edit',     'description' => 'Edit vendor invoice details (while pending)'],
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'delete',   'description' => 'Cancel vendor invoices'],
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'approve',  'description' => 'Approve, reject, or revise vendor invoices (Finance stage)'],
            ['module' => 'procurement', 'feature' => 'invoices', 'action' => 'view_all', 'description' => 'See every vendor invoice in the organisation, not just records that concern this user'],
        ...
        */
        $roleDefaults = [
            'admin' => [
                ...
                'procurement.purchase_orders.view_all' => true,
                ...
                'procurement.requisitions.view_all' => true,
            ...
            'manager' => [
                ...
                'procurement.purchase_orders.edit' => true,
                'procurement.purchase_orders.delete' => true,
                'procurement.purchase_orders.view_all' => false,
                'procurement.inventory.view' => true,
                'procurement.inventory.create' => true,
                'procurement.inventory.edit' => true,
                'procurement.inventory.delete' => true,
                ...
                'procurement.requisitions.edit' => true,
                'procurement.requisitions.delete' => true,
                'procurement.requisitions.view_all' => false,
                'procurement.approval.manager_review' => true,
                ...
                'procurement.rfq.view_all' => false,
                'procurement.grn.view' => true,
                'procurement.grn.create' => true,
                'procurement.grn.edit' => true,
                ...
                'procurement.rfp.view_all' => false,
                'procurement.invoices.view' => true,
                'procurement.invoices.create' => true,
                'procurement.invoices.edit' => true,
