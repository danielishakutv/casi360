...
| Page | Status | Notes |
|------|--------|-------|
| Vendors | ✅ Live | Full CRUD + vendor_code, category, rating, blacklisted |
| Vendor Categories | ✅ Live | Full CRUD endpoints created |
| Purchase Requests (list) | ✅ Live | Maps to `/procurement/requisitions` |
| Create Purchase Request | ✅ Live | All extra fields now accepted (signoffs, delivery, currency, etc.) |
| Purchase Orders (list) | ✅ Live | Includes disbursement view + create in detail modal |
| Create Purchase Order | ✅ Live | All extra fields now accepted (deliver-to, signoffs, payment_terms, etc.) |
| Procurement Overview | ✅ Live | All entities now have backend endpoints |
| Inventory Items | ✅ Live | New page |
| Pending Approvals | ✅ Live | New page |
| BOQ | ✅ Live | Full CRUD + line items |
| RFQ | ✅ Live | Full CRUD + line items |
| GRN | ✅ Live | Full CRUD + line items + signoffs |
| RFP | ✅ Live | Full CRUD + tax calc + signoffs |
...
|------------------|--------|---------------|
| Vendor Categories | ✅ Done | Migration 000032, full CRUD at `/procurement/vendor-categories` |
| BOQ | ✅ Done | Migration 000036, full CRUD + line items at `/procurement/boq` |
| RFQ | ✅ Done | Migration 000037, full CRUD + line items at `/procurement/rfq` |
| GRN | ✅ Done | Migration 000038, full CRUD + line items + signoffs at `/procurement/grn` |
| RFP | ✅ Done | Migration 000039, full CRUD + tax calc + signoffs at `/procurement/rfp` |
| Vendor extra fields | ✅ Done | Migration 000033 — vendor_code, category_id, rating, blacklisted status |
| Requisition extra fields | ✅ Done | Migration 000034 — delivery_location, purchase_scenario, logistics, currency, project/donor, signoffs |
| PO extra fields | ✅ Done | Migration 000035 — pr_reference, rfq_reference, deliver-to, payment_terms, delivery_charges, signoffs |
