...
|---|---------|--------|--------|----------|
| 1 | Leave Types & Holidays | HR | ✅ Done | High |
| 2 | Vendor Categories | Procurement | ✅ Done | High |
| 3 | Bill of Quantities (BOQ) | Procurement | ✅ Done | High |
| 4 | Request for Quotation (RFQ) | Procurement | ✅ Done | High |
| 5 | Goods Received Note (GRN) | Procurement | ✅ Done | High |
| 6 | Request for Payment (RFP) | Procurement | ✅ Done | High |
| 7 | Procurement Overview stats | Procurement | ✅ Done | Medium |
| 8 | Send Email | Communication | ✅ Done | Medium |
| 9 | Send SMS | Communication | ✅ Done | Medium |
| 10 | Vendor extra fields | Procurement | ✅ Done | Medium |
| 11 | Requisition extra fields | Procurement | ✅ Done | Medium |
| 12 | Roles & Access settings | Settings | ✅ Done | Low |
| 13 | Audit Log | Settings | ✅ Done | Low |
| 14 | Data & Backup | Settings | ✅ Done | Low |
| 15 | Beneficiaries | Programs | ✅ Done | Low |
| 16 | Program Reports | Programs | ✅ Done | Low |
| 17 | Help Center | Shared | ✅ Done | Low |
